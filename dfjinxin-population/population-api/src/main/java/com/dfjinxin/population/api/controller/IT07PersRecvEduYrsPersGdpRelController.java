 ...
 */
@FeignClient(contextId = "home_t07persrecveduyrspersgdprel",
        name = FeignClientConfig.NAME, configuration = FeignClientsConfiguration.class)
@RequestMapping("home/t07persrecveduyrspersgdprel")
public interface IT07PersRecvEduYrsPersGdpRelController {
