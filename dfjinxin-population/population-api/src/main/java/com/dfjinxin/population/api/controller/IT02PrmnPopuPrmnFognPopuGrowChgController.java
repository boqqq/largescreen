 ...
 */
@FeignClient(contextId = "home_t02prmnpopuprmnfognpopugrowchg",
        name = FeignClientConfig.NAME, configuration = FeignClientsConfiguration.class)
@RequestMapping("home/t02prmnpopuprmnfognpopugrowchg")
public interface IT02PrmnPopuPrmnFognPopuGrowChgController {
