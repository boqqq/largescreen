 ...
 */
@FeignClient(contextId = "home_t02zoneprmnfognpopuincchg",
        name = FeignClientConfig.NAME, configuration = FeignClientsConfiguration.class)
@RequestMapping("home/t02zoneprmnfognpopuincchg")
public interface IT02ZonePrmnFognPopuIncChgController {
