 ...
 */
@FeignClient(contextId = "home_t02zonehousdrgstpopuincchg",
        name = FeignClientConfig.NAME, configuration = FeignClientsConfiguration.class)
@RequestMapping("home/t02zonehousdrgstpopuincchg")
public interface IT02ZoneHousdRgstPopuIncChgController {
